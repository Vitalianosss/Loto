...
let proverkaProcent = document.querySelector('.proverka-procent');
let proverkaVh = document.querySelector('.proverka-vh');

/*document.addEventListener('touchstart', () => {
    if (proverkaVh > (proverkaProcent - 20) || proverkaVh > (proverkaProcent + 20)) {
